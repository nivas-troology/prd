 ...
 page:number=1
  ...
  ngOnInit(): void {
   ...
   if(this.MRoleId==1)
   {
    ...
    this.spinner.show();
      this.reportservice.getRetirementJawan(this.ZoneId,this.DistId,0,'~').subscribe((data:any)=>{this.retirementJawanlist=data;
        this.spinner.hide();
        this.totalReords=this.retirementJawanlist.length;
      
        if(this.retirementJawanlist.length<0)
        {
   ...
   this.spinner.show();
   this.reportservice.getRetirementJawan(parseInt(this.ZoneId),this.DistId,0).subscribe((data:any)=>{this.retirementJawanlist=data;
     this.spinner.hide();
     this.totalReords=this.retirementJawanlist.length;
     this.rerender();
     this.dtOptions = {
   ...
   else if(this.MRoleId==3)
   {
    ...
    this.spinner.show();
      this.reportservice.getRetirementJawan(parseInt(this.ZoneId),parseInt(this.DistId),0,'~').subscribe((data:any)=>{this.retirementJawanlist=data;
        this.spinner.hide();
        this.totalReords=this.retirementJawanlist.length;
      this.rerender();
      this.dtOptions = {
 ...
 ClickUrbanRuralCurrent()
{
  ...
  // Get All Jawans
  retirementJawanlist:any;
  getRetirementJawan(ZoneId,DistId,CompanyId,residanceTypeCurrent)
  { 
    if(ZoneId=="--Select--")
    {
      ZoneId=0;
   ...
   if(ZoneId>0 || DistId>0 ||CompanyId>0)
    {
      this.spinner.show();
      this.reportservice.getRetirementJawan(ZoneId,DistId,CompanyId,residanceTypeCurrent).subscribe((data:any)=>{this.retirementJawanlist=data;
        this.spinner.hide();
        this.totalReords=this.retirementJawanlist.length;
   ...
   {
    this.spinner.show();
    this.reportservice.getRetirementJawan(0,0,0,'~').subscribe((data:any)=>{this.retirementJawanlist=data;
